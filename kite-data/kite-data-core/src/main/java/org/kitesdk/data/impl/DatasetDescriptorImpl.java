...
public class DatasetDescriptorImpl extends DatasetDescriptor {
  ...
  public boolean equals(@Nullable Object obj) {
    ...
    final DatasetDescriptorImpl other = (DatasetDescriptorImpl) obj;
    return (
   ...
   */
  public static class Builder extends DatasetDescriptor.Builder {
     ...
     * @since 0.9.0
     */
    public DatasetDescriptorImpl build() {
  ...
  public static class DatasetDescriptorImplFactory implements DatasetDescriptorFactory {
    ...
    @Override
    public DatasetDescriptor newDatasetDescriptor(Schema schema, URI schemaUri,
        Format format, URI location, Map<String, String> properties,
        PartitionStrategy partitionStrategy, ColumnMapping columnMapping,
  ...
  public static class DatasetDescriptorImplBuilderFactory implements DatasetDescriptorBuilderFactory {
    ...
    @Override
    public DatasetDescriptor.Builder newBuilder(DatasetDescriptor descriptor) {
